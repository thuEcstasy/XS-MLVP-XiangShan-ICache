...
module ICache(
  ...
  wire         _wayLookup_io_read_bits_entry_meta_corrupt_0;
  wire         _wayLookup_io_read_bits_entry_meta_corrupt_1;
  wire [49:0]  _wayLookup_io_read_bits_gpf_gpaddr;
  ...
  wire         _prefetcher_io_wayLookupWrite_bits_entry_meta_corrupt_0;
  wire         _prefetcher_io_wayLookupWrite_bits_entry_meta_corrupt_1;
  wire [49:0]  _prefetcher_io_wayLookupWrite_bits_gpf_gpaddr;
  ...
  wire [35:0]  _metaArray_io_readResp_metaData_0_0_tag;
  wire [35:0]  _metaArray_io_readResp_metaData_0_1_tag;
  wire [35:0]  _metaArray_io_readResp_metaData_0_2_tag;
  wire [35:0]  _metaArray_io_readResp_metaData_0_3_tag;
  wire [35:0]  _metaArray_io_readResp_metaData_1_0_tag;
  wire [35:0]  _metaArray_io_readResp_metaData_1_1_tag;
  wire [35:0]  _metaArray_io_readResp_metaData_1_2_tag;
  wire [35:0]  _metaArray_io_readResp_metaData_1_3_tag;
    ...
    if (reset) begin
      ...
      if (errors_valid) begin
        io_error_bits_r_paddr <=
          (_mainPipe_io_errors_0_valid ? _mainPipe_io_errors_0_bits_paddr : 48'h0)
          | (_mainPipe_io_errors_1_valid ? _mainPipe_io_errors_1_bits_paddr : 48'h0);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_error_bits_r_paddr = {_RANDOM[3'h3][31:22], _RANDOM[3'h4], _RANDOM[3'h5][5:0]};
        io_error_bits_r_report_to_beu = _RANDOM[3'h5][6];
        io_error_valid_REG = _RANDOM[3'h5][7];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        softPrefetchValid = 1'h0;
        softPrefetch_startAddr = 50'h0;
  ...
  ICacheMainPipe mainPipe (
    ...
    .io_wayLookupRead_bits_entry_meta_corrupt_0
      (_wayLookup_io_read_bits_entry_meta_corrupt_0),
    .io_wayLookupRead_bits_entry_meta_corrupt_1
      (_wayLookup_io_read_bits_entry_meta_corrupt_1),
  ...
  IPrefetchPipe prefetcher (
    ...
    .io_metaRead_fromIMeta_metaData_0_0_tag
      (_metaArray_io_readResp_metaData_0_0_tag),
    .io_metaRead_fromIMeta_metaData_0_1_tag
      (_metaArray_io_readResp_metaData_0_1_tag),
    .io_metaRead_fromIMeta_metaData_0_2_tag
      (_metaArray_io_readResp_metaData_0_2_tag),
    .io_metaRead_fromIMeta_metaData_0_3_tag
      (_metaArray_io_readResp_metaData_0_3_tag),
    .io_metaRead_fromIMeta_metaData_1_0_tag
      (_metaArray_io_readResp_metaData_1_0_tag),
    .io_metaRead_fromIMeta_metaData_1_1_tag
      (_metaArray_io_readResp_metaData_1_1_tag),
    .io_metaRead_fromIMeta_metaData_1_2_tag
      (_metaArray_io_readResp_metaData_1_2_tag),
    .io_metaRead_fromIMeta_metaData_1_3_tag
      (_metaArray_io_readResp_metaData_1_3_tag),
    ...
    .io_wayLookupWrite_bits_entry_meta_corrupt_0
      (_prefetcher_io_wayLookupWrite_bits_entry_meta_corrupt_0),
    .io_wayLookupWrite_bits_entry_meta_corrupt_1
      (_prefetcher_io_wayLookupWrite_bits_entry_meta_corrupt_1),
  ...
  WayLookup wayLookup (
    ...
    .io_read_bits_entry_itlb_exception_1
      (_wayLookup_io_read_bits_entry_itlb_exception_1),
    .io_read_bits_entry_meta_corrupt_0    (_wayLookup_io_read_bits_entry_meta_corrupt_0),
    .io_read_bits_entry_meta_corrupt_1    (_wayLookup_io_read_bits_entry_meta_corrupt_1),
    ...
    .io_write_bits_entry_itlb_exception_1
      (_prefetcher_io_wayLookupWrite_bits_entry_itlb_exception_1),
    .io_write_bits_entry_meta_corrupt_0
      (_prefetcher_io_wayLookupWrite_bits_entry_meta_corrupt_0),
    .io_write_bits_entry_meta_corrupt_1
      (_prefetcher_io_wayLookupWrite_bits_entry_meta_corrupt_1),
