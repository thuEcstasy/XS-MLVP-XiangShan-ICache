...
module ICacheMissUnit(
  ...
  wire [15:0][41:0] _GEN_0 =
    {{_fetchMSHRs_0_io_resp_bits_blkPaddr},
     ...
     {_fetchMSHRs_0_io_resp_bits_blkPaddr}};
  wire [41:0]       io_fetch_resp_bits_blkPaddr_0 = _GEN_0[id_r];
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      corrupt_r <= _GEN_3 & io_mem_grant_bits_corrupt | ~fetch_resp_valid & corrupt_r;
    end
  end // always @(posedge, posedge)
  always @(posedge clock) begin
    last_fire_r <= io_mem_grant_valid & io_mem_grant_bits_opcode[0] & readBeatCnt;
  ...
  assign io_meta_write_bits_phyTag = io_fetch_resp_bits_blkPaddr_0[41:6];
