...
module SRAMTemplate(
  ...
  array array (
    ...
    .RW0_wmode (wen),
    .RW0_wdata
      ({_resetState ? 37'h0 : io_w_req_bits_data_3,
        _resetState ? 37'h0 : io_w_req_bits_data_2,
        _resetState ? 37'h0 : io_w_req_bits_data_1,
        _resetState ? 37'h0 : io_w_req_bits_data_0}),
  ...
  assign io_r_resp_data_2 = rdata_last_REG ? _array_RW0_rdata[110:74] : rdata_hold_data_2;
