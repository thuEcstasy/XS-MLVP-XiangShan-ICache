...
module ICacheMainPipe(
  ...
  input          io_wayLookupRead_bits_entry_meta_corrupt_0,
  input          io_wayLookupRead_bits_entry_meta_corrupt_1,
  input  [49:0]  io_wayLookupRead_bits_gpf_gpaddr,
  ...
  output [49:0]  io_fetch_resp_0_bits_vaddr,
  output [511:0] io_fetch_resp_0_bits_data,
  output [47:0]  io_fetch_resp_0_bits_paddr,
  output [49:0]  io_fetch_resp_0_bits_gpaddr,
  output [1:0]   io_fetch_resp_0_bits_exception,
  output         io_fetch_resp_0_bits_mmio,
  output         io_fetch_resp_1_valid,
  output [49:0]  io_fetch_resp_1_bits_vaddr,
  output [1:0]   io_fetch_resp_1_bits_exception,
  ...
  reg         s1_waymasks_1_2;
  reg         s1_waymasks_1_3;
  reg         s1_meta_corrupt_0;
  reg         s1_meta_corrupt_1;
  ...
  wire        s2_data_corrupt_1 =
    (s2_bank_corrupt_0 & s2_bankSel_bankIdxLow < 4'h9 & _s2_bankSel_bankIdxHigh_T_1[6]
     | s2_bank_corrupt_1 & s2_bankSel_bankIdxLow < 4'hA
     & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'h8 | s2_bank_corrupt_2
     & s2_bankSel_bankIdxLow < 4'hB & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'h9
     | s2_bank_corrupt_3 & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'hA | s2_bank_corrupt_4
     & s2_bankSel_bankIdxLow < 4'hD & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'hB
     | s2_bank_corrupt_5 & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'hC | s2_bank_corrupt_6
     & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'hD | s2_bank_corrupt_7
     & (&(_s2_bankSel_bankIdxHigh_T_1[6:3]))) & s2_SRAMhits_1;
  reg         s2_meta_corrupt_0;
  reg         s2_meta_corrupt_1;
  reg         io_errors_0_valid_REG;
  wire        _io_errors_0_bits_report_to_beu_T_1 = s2_meta_corrupt_0 | s2_data_corrupt_0;
  reg         io_errors_0_bits_report_to_beu_REG;
  reg         io_errors_1_valid_REG;
  wire        _io_errors_1_bits_report_to_beu_T_1 = s2_meta_corrupt_1 | s2_data_corrupt_1;
  reg         io_errors_1_bits_report_to_beu_REG;
  reg         s2_l2_corrupt_0;
  reg         s2_l2_corrupt_1;
  wire        _s2_miss_T_8 = s2_exception_0 == 2'h0;
  wire        s2_miss_0 = ~s2_hits_0 & _s2_miss_T_8 & ~s2_mmio_0;
  wire        s2_miss_1 =
    ~s2_hits_1 & s2_doubleline & _s2_miss_T_8 & s2_exception_1 == 2'h0 & ~s2_mmio_0
    & ~s2_mmio_1;
  reg         has_send_0;
  reg         has_send_1;
  ...
  wire        _s2_data_exception_T = io_csr_parity_enable & s2_data_corrupt_0;
  wire        _s2_data_exception_T_2 = io_csr_parity_enable & s2_data_corrupt_1;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      s1_meta_corrupt_0 <= 1'h0;
      s1_meta_corrupt_1 <= 1'h0;
      s1_hits_valid <= 1'h0;
      ...
      if (s0_fire) begin
        ...
        s1_meta_corrupt_0 <= io_wayLookupRead_bits_entry_meta_corrupt_0;
        s1_meta_corrupt_1 <= io_wayLookupRead_bits_entry_meta_corrupt_1;
      end
      ...
      if (s1_fire) begin
        ...
        s2_exception_0 <=
          (|s1_itlb_exception_0)
            ...
            : io_pmp_0_resp_instr
                ...
                : {2{io_csr_parity_enable & s1_meta_corrupt_0}};
        s2_exception_1 <=
          (|s1_itlb_exception_1)
            ? s1_itlb_exception_1
            : io_pmp_1_resp_instr
                ? {2{io_pmp_1_resp_instr}}
                : {2{io_csr_parity_enable & s1_meta_corrupt_1}};
        ...
        s2_meta_corrupt_0 <= s1_meta_corrupt_0;
        s2_meta_corrupt_1 <= s1_meta_corrupt_1;
      end
      else begin
        ...
        if ((s2_req_vaddr_0[5:3] == 3'h0 & s2_bankMSHRHit_7 | (|(s2_req_vaddr_0[5:3]))
             & s2_MSHR_hits_1) & ~io_mshr_resp_bits_corrupt)
        ...
        if (s2_bankMSHRHit_7 & ~io_mshr_resp_bits_corrupt)
  ...
  always @(posedge clock) begin
    ...
    REG <= s2_fire & s2_l2_corrupt_0;
    io_errors_0_bits_paddr_REG <= s2_req_paddr_0;
    REG_1 <= s2_fire & s2_l2_corrupt_1;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_gpaddr = {_RANDOM[6'h6][31:13], _RANDOM[6'h7][30:0]};
        s1_doubleline = _RANDOM[6'h7][31];
        s1_SRAMhits_0 = _RANDOM[6'h8][0];
        s1_SRAMhits_1 = _RANDOM[6'h8][1];
        s1_itlb_exception_0 = _RANDOM[6'h8][3:2];
        s1_itlb_exception_1 = _RANDOM[6'h8][5:4];
        s1_waymasks_0_0 = _RANDOM[6'h8][6];
        s1_waymasks_0_1 = _RANDOM[6'h8][7];
        s1_waymasks_0_2 = _RANDOM[6'h8][8];
        s1_waymasks_0_3 = _RANDOM[6'h8][9];
        s1_waymasks_1_0 = _RANDOM[6'h8][10];
        s1_waymasks_1_1 = _RANDOM[6'h8][11];
        s1_waymasks_1_2 = _RANDOM[6'h8][12];
        s1_waymasks_1_3 = _RANDOM[6'h8][13];
        s1_meta_corrupt_0 = _RANDOM[6'h8][14];
        s1_meta_corrupt_1 = _RANDOM[6'h8][15];
        io_touch_0_valid_REG = _RANDOM[6'h8][16];
        io_touch_1_valid_REG = _RANDOM[6'h8][17];
        s1_hits_REG = _RANDOM[6'h8][18];
        s1_hits_valid = _RANDOM[6'h8][19];
        s1_hits_REG_1 = _RANDOM[6'h8][20];
        s1_hits_valid_1 = _RANDOM[6'h8][21];
        s1_datas_REG = _RANDOM[6'h8][22];
        s1_datas_r = {_RANDOM[6'h8][31:23], _RANDOM[6'h9], _RANDOM[6'hA][22:0]};
        s1_datas_REG_1 = _RANDOM[6'hA][23];
        s1_datas_r_1 = {_RANDOM[6'hA][31:24], _RANDOM[6'hB], _RANDOM[6'hC][23:0]};
        s1_datas_REG_2 = _RANDOM[6'hC][24];
        s1_datas_r_2 = {_RANDOM[6'hC][31:25], _RANDOM[6'hD], _RANDOM[6'hE][24:0]};
        s1_datas_REG_3 = _RANDOM[6'hE][25];
        s1_datas_r_3 = {_RANDOM[6'hE][31:26], _RANDOM[6'hF], _RANDOM[6'h10][25:0]};
        s1_datas_REG_4 = _RANDOM[6'h10][26];
        s1_datas_r_4 = {_RANDOM[6'h10][31:27], _RANDOM[6'h11], _RANDOM[6'h12][26:0]};
        s1_datas_REG_5 = _RANDOM[6'h12][27];
        s1_datas_r_5 = {_RANDOM[6'h12][31:28], _RANDOM[6'h13], _RANDOM[6'h14][27:0]};
        s1_datas_REG_6 = _RANDOM[6'h14][28];
        s1_datas_r_6 = {_RANDOM[6'h14][31:29], _RANDOM[6'h15], _RANDOM[6'h16][28:0]};
        s1_datas_REG_7 = _RANDOM[6'h16][29];
        s1_datas_r_7 = {_RANDOM[6'h16][31:30], _RANDOM[6'h17], _RANDOM[6'h18][29:0]};
        s1_codes_REG = _RANDOM[6'h18][30];
        s1_codes_r_0 = _RANDOM[6'h18][31];
        s1_codes_r_1 = _RANDOM[6'h19][0];
        s1_codes_r_2 = _RANDOM[6'h19][1];
        s1_codes_r_3 = _RANDOM[6'h19][2];
        s1_codes_r_4 = _RANDOM[6'h19][3];
        s1_codes_r_5 = _RANDOM[6'h19][4];
        s1_codes_r_6 = _RANDOM[6'h19][5];
        s1_codes_r_7 = _RANDOM[6'h19][6];
        s2_valid = _RANDOM[6'h19][7];
        s2_req_vaddr_0 = {_RANDOM[6'h19][31:8], _RANDOM[6'h1A][25:0]};
        s2_req_vaddr_1 = {_RANDOM[6'h1A][31:26], _RANDOM[6'h1B], _RANDOM[6'h1C][11:0]};
        s2_req_ptags_0 = {_RANDOM[6'h1C][31:12], _RANDOM[6'h1D][15:0]};
        s2_req_ptags_1 = {_RANDOM[6'h1D][31:16], _RANDOM[6'h1E][19:0]};
        s2_req_gpaddr = {_RANDOM[6'h1E][31:20], _RANDOM[6'h1F], _RANDOM[6'h20][5:0]};
        s2_doubleline = _RANDOM[6'h20][6];
        s2_exception_0 = _RANDOM[6'h20][8:7];
        s2_exception_1 = _RANDOM[6'h20][10:9];
        s2_mmio_0 = _RANDOM[6'h20][11];
        s2_mmio_1 = _RANDOM[6'h20][12];
        s2_SRAMhits_0 = _RANDOM[6'h20][13];
        s2_SRAMhits_1 = _RANDOM[6'h20][14];
        s2_codes_0 = _RANDOM[6'h20][15];
        s2_codes_1 = _RANDOM[6'h20][16];
        s2_codes_2 = _RANDOM[6'h20][17];
        s2_codes_3 = _RANDOM[6'h20][18];
        s2_codes_4 = _RANDOM[6'h20][19];
        s2_codes_5 = _RANDOM[6'h20][20];
        s2_codes_6 = _RANDOM[6'h20][21];
        s2_codes_7 = _RANDOM[6'h20][22];
        s2_hits_0 = _RANDOM[6'h20][23];
        s2_hits_1 = _RANDOM[6'h20][24];
        s2_datas_0 = {_RANDOM[6'h20][31:25], _RANDOM[6'h21], _RANDOM[6'h22][24:0]};
        s2_datas_1 = {_RANDOM[6'h22][31:25], _RANDOM[6'h23], _RANDOM[6'h24][24:0]};
        s2_datas_2 = {_RANDOM[6'h24][31:25], _RANDOM[6'h25], _RANDOM[6'h26][24:0]};
        s2_datas_3 = {_RANDOM[6'h26][31:25], _RANDOM[6'h27], _RANDOM[6'h28][24:0]};
        s2_datas_4 = {_RANDOM[6'h28][31:25], _RANDOM[6'h29], _RANDOM[6'h2A][24:0]};
        s2_datas_5 = {_RANDOM[6'h2A][31:25], _RANDOM[6'h2B], _RANDOM[6'h2C][24:0]};
        s2_datas_6 = {_RANDOM[6'h2C][31:25], _RANDOM[6'h2D], _RANDOM[6'h2E][24:0]};
        s2_datas_7 = {_RANDOM[6'h2E][31:25], _RANDOM[6'h2F], _RANDOM[6'h30][24:0]};
        s2_meta_corrupt_0 = _RANDOM[6'h30][25];
        s2_meta_corrupt_1 = _RANDOM[6'h30][26];
        io_errors_0_valid_REG = _RANDOM[6'h30][27];
        io_errors_0_bits_report_to_beu_REG = _RANDOM[6'h30][28];
        io_errors_1_valid_REG = _RANDOM[6'h30][29];
        io_errors_1_bits_report_to_beu_REG = _RANDOM[6'h30][30];
        s2_l2_corrupt_0 = _RANDOM[6'h30][31];
        s2_l2_corrupt_1 = _RANDOM[6'h31][0];
        has_send_0 = _RANDOM[6'h31][1];
        has_send_1 = _RANDOM[6'h31][2];
        REG = _RANDOM[6'h31][3];
        io_errors_0_bits_paddr_REG = {_RANDOM[6'h31][31:4], _RANDOM[6'h32][19:0]};
        REG_1 = _RANDOM[6'h32][20];
        io_errors_1_bits_paddr_REG =
          {_RANDOM[6'h32][31:21], _RANDOM[6'h33], _RANDOM[6'h34][4:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_req_vaddr_0 = 50'h0;
  ...
  assign io_fetch_resp_0_bits_exception =
    (|s2_exception_0)
      ? s2_exception_0
      : _s2_data_exception_T ? {2{_s2_data_exception_T}} : {2{s2_l2_corrupt_0}};
  assign io_fetch_resp_0_bits_mmio = s2_mmio_0;
  assign io_fetch_resp_1_valid = s2_fire & s2_doubleline;
  assign io_fetch_resp_1_bits_vaddr = s2_req_vaddr_1;
  assign io_fetch_resp_1_bits_exception =
    s2_doubleline
      ? ((|s2_exception_1)
           ? s2_exception_1
           : _s2_data_exception_T_2 ? {2{_s2_data_exception_T_2}} : {2{s2_l2_corrupt_1}})
      : 2'h0;
